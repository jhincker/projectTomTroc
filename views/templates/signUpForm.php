...
<div class="grid min-h-screen grid-cols-2">
    <div class="connection-form flex items-center justify-center">
        <form action="index.php?action=signUpUser" method="post" class="foldedCorner gap-8">
            <h2 class="font-serif text-2xl mb-4">Inscription</h2>
            <div class="formGrid flex flex-col space-y-4">
                <label for="username">Pseudo</label>
                <input class="border border-2 hover:border-blue-500 p-1 rounded-md" type="text" name="username" id="username" required>
